...
// Cronometro arranca
function startCrono() {
    // Detenemos el intervalo clearInterval(crono);
    clearInterval(crono);
...
function start() {
    ...
    // Aumento el contador en 1 porque la ecuación se ejcuta cada centésima de segundo
    contadorCents++;

    // Compreubo si las centésimas llegan a 100 y si es así reiniciar el contador y aumentar un segundo
    ...
    // La función se ejecuta cada 10 ms (1 centésima de segundo)
    // setTimeout(start, 10)
}
// Detenemos el blucle
function stop() {
